...
async function deploy() {
    try {
        ...
        if (
            ...
            child_process.execSync('sudo PROVIDER="' + configs.provider + '" MNEMONIC="' + configs.owner_mnemonic + '" ME_ADDRESS="' + configs.me_address + '"  CONFIG="' + './configs/' + argv._ + '.json' + '" truffle deploy --network ' + configs.network + ' --reset', {
                stdio: 'inherit'
            })
